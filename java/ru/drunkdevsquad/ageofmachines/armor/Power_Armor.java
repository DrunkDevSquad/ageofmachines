...
public class Power_Armor extends ItemArmor{
	
	private String texturePath = "mybestmod:textures/model/armor/";
	
	public Power_Armor(int id, int armorType) {
		super(AOM_Materials.Power_Armor_Material, id, armorType);
	...
	public void setTextureName ()
	{
		if(armorType == 0||armorType == 1||armorType == 3){
			this.texturePath += "Power_Armor_" + 1 + ".png";
		}
		else {
			this.texturePath += "Power_Armor_" + 2 + ".png";
		}
	}
