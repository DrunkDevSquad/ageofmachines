...
public class Gold_Ore_Cluster extends Block {
	
	public Gold_Ore_Cluster() {
		
		super(Material.rock);
		this.setCreativeTab(AOM_Core.tabaomblocks);
		this.setBlockName("GoldOreCluster");
		this.setBlockTextureName("ageofmachines:goldorecluster");
